...
{
    public interface ICourseRepository : ISearchableRepository<Course, Guid, CourseSearchOptions>
    {
        /// <summary>
        ...
        /// <summary>
        /// Mark all of the provided courses as complete for the provided student
        /// </summary>
